            ...
            {user ? (
              <div className="flex items-center gap-2">
                ...
                <div className="relative">
                  ...
                  >
                    <div className="w-8 h-8 rounded-full bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 flex items-center justify-center font-bold text-slate-700 dark:text-slate-200 text-xs relative">
                      {user.name ? user.name.charAt(0) : 'U'}
                      {user.isCR && (
                        <Crown className="w-3.5 h-3.5 text-amber-500 fill-amber-400 absolute -top-1 -right-1" />
                      )}
                    </div>

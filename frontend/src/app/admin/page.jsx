    ...
    return (
      <div className="max-w-md mx-auto py-16 px-4 text-center">
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-8 border border-slate-100 dark:border-slate-800 shadow-xl space-y-4">
          ...
          <h2 className="text-xl font-extrabold text-slate-900 dark:text-white">Admin Access Restricted</h2>
          <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
            You must be logged in as an Administrator (`admin@gmail.com`) to manage users and assign CR roles.
          </p>
          <Link
            href="/login"
    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-gradient-to-br from-slate-900 via-slate-850 to-purple-950 p-6 sm:p-8 rounded-3xl text-white shadow-xl relative overflow-hidden">
        <div className="space-y-2 relative z-10">
          ...
          <h1 className="text-2xl sm:text-3xl font-extrabold tracking-tight">User Governance & CR Management</h1>
          <p className="text-xs text-slate-300">Manage user accounts, assign Class Representatives (CR), and update permissions</p>
        </div>
                    ...
                    <td className="py-4 px-6 text-right">
                      {deletingId === u._id ? (
                        ...
                        <button
                          ...
                          className="p-2 rounded-xl border border-slate-200 dark:border-slate-800 text-rose-500 hover:bg-rose-50 dark:hover:bg-rose-950/60 transition-colors"
                        >

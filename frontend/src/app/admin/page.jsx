  ...
  return (
    <div className="space-y-8">
      ...
      {activeTab === 'sectionRequests' ? (
        ...
        <>
          {/* Role Differentiation Quick Selector Tabs */}
          <div className="flex items-center gap-2 p-1.5 rounded-2xl bg-slate-100 dark:bg-slate-800/80 border border-slate-200/60 dark:border-slate-800 text-xs">
            <button
              type="button"
            ...
            >
              ...
              <span>All Accounts ({totalUsers})</span>
            </button>
            ...
            >
              ...
              <span>Students Directory ({studentCount})</span>
            </button>
            ...
            <button
              ...
              className={`flex-1 py-2 px-3 rounded-xl font-bold flex items-center justify-center gap-2 transition-all ${
                roleFilter === 'faculty'
                  ...
                  : 'text-slate-600 dark:text-slate-400 hover:bg-indigo-50 dark:hover:bg-indigo-950/40 hover:text-indigo-600'
              }`}
            >
              <Briefcase className="w-4 h-4" />
              <span>Faculty Directory ({facultyCount})</span>
            </button>
